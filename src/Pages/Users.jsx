  ...
  return (
    <div className='p-8 flex flex-col gap-7'>
      ...
      <div className='border border-[#1F2937]  bg-[#111827] py-2 px-4 rounded-lg flex items-center gap-2'>
        ...
        <input className='w-full text-[#F9FAFB] focus:outline-none text-lg placeholder:text-lg border-r border-gray-500 placeholder:text-[#9CA3AF]' placeholder='Search Users' type="text" />
